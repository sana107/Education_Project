...
const Test = () => {
    ...
    //   const {tabExam} = useSelector((state)=>state.Book);
    // console.log(tabExam,'hii')
    const {tabExam} = useSelector((state)=>state.Book);
    ...
    const currentData = Array.isArray(tabExam[selectedTab]?.exams)
    ? tabExam[selectedTab].exams
        ...
        {/* <div className='book-section-box'>
          ...
          <div className="books-content">
            <Box className="examinnerbox" >
              ...
              >
                {Object.keys(tabExam).map((key, index) => (
                  <Tab
                    style={{
                      fontSize: '16px',
                      fontWeight: '500',
                    ...
                    key={index}
                    label={
                    <span style={{ fontSize: '12px', marginRight: 'auto', fontFamily: "'Poppins', sans-serif", }}>
                      {tabExam[key].label}
                    </span>}
                    icon={
                      <p>
              ...
              <div className='paddininsideboxestest'>
              <div className='d-flex mt-4 ' style={{ justifyContent: 'space-between' }}>
                <div><h5 className="examheading">{tabExam[selectedTab].span}</h5></div>
                <div>
                ...
                <Grid container spacing={3} className='bookwrap'>
                  {displayedData.map((exam, index) => (
                    <Grid item key={index} >
                      ...
                      >
                        <Box className='testbox' sx={{ alignContent: 'center', textAlign: '' }}>
                            ...
                            {exam.title}
                                ...
                                <div className='test-icon'>
                                    <img src="https://i.ibb.co/ZSxFbrZ/ri-share-line.png" alt="" />
                                    <img src="https://i.ibb.co/jzq8BxL/Vector.png" alt="" />
                                    <img src="https://i.ibb.co/wM01kZD/Vector-1.png" alt="" />
                                </div>
                            </div>
                              <div className='text-flex textdata'>
                                <div>
                                  <span>250 Marks</span>
                                </div>
                                <div>
                              ...
                              <div className='testlanguage23'>
                                <img src="https://i.ibb.co/5Y0NM69/Vector-2.png" alt="" /> <span>English</span> <span>Hindi</span>
                              </div>
                              <div className='text-flex textdata'>
                                <div>
                                  <span>75 Attempts in last 5 days</span>
                                </div>
                                <div>
