...
import UserId from "../editProfile/UserId";
            ...
            <div class="container-fluid p-0">
              <div className="d-flex" style={{ alignItems: "center" }}>
                <div>
                  <Link to="/">
                    <img
                      src="https://i.ibb.co/2q9TGNp/Screenshot-2024-12-31-113232.png"
                      alt=""
                    />
                  </Link>
                </div>
              ...
              >
                ...
                <img
                  ...
                  src="https://i.ibb.co/PjJStmW/Screenshot-2025-01-02-164403.png"
                  alt=""
                />
              </button>
              <div
              ...
              >
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                      <a class="nav-link textblack navbartexthover" href="/">
                        Home
                      </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      >
                        <a
                          className="nav-link textblack navbartexthover"
                          href="#"
                        >
                          Free Quizzes
                        </a>
                        <i
                          className={`fa-solid ${
                            isDropdownOpen ? "fa-minus" : "fa-plus"
                          }`}
                        ></i>
                      </div>
                      <ul
